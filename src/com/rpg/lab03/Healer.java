...
public class Healer extends Character {
    ...
    public Healer(String name, int level, int healthPointsMax, double damage, int defense, Weapon weapon, int healpoints){
        super(name, level, healthPointsMax, damage , defense, weapon, "healer");
