...
public class LibraryManagementApp {
    public static void main(String[] args) {
        ...
        items.add(new PhysicalBook("Design Patterns", "Gang of Four", "978-0201633612",
                680.0, "A3-22"));
        // Add E-Books
        items.add(new EBook("Effective Java", "Joshua Bloch", "978-0134685991", 99,
                "https://library.ebooks.com/effective-java.pdf", 5.2));
        items.add(new EBook("Python Crash Course", "Eric Matthes", "978-1593279288", 99,
                "https://library.ebooks.com/python-crash.pdf", 8.7));
        // Add Library Movies (Digital Content)
        LibraryMovie movie1 = new LibraryMovie(
                "Inception",
                "Christopher Nolan",
                "https://library.movies.com/inception.mp4",
                148,
                2010,
                "Sci-Fi",
                199.0,
        ...
        LibraryMovie movie2 = new LibraryMovie(
                "Interstellar",
                "Christopher Nolan",
                "https://library.movies.com/interstellar.mp4",
                169,
                2014,
                "Sci-Fi",
                219.0,
        ...
        // Process Library Movies (also DigitalContent)
        System.out.println("\nProcessing Library Movies:\n");
        launchStreamingPlayer(movie1);
        launchStreamingPlayer(movie2);
