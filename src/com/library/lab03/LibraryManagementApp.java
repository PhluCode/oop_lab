...
public class LibraryManagementApp {
    public static void main(String[] args) {
        ...
        physicalBooks.add(new PhysicalBook("Design Patterns", "Gang of Four", "978-0201633612",
                680.0, "A3-22"));
        // Add E-Books
        eBooks.add(new EBook("Effective Java", "Joshua Bloch", "978-0134685991", 100,
                "https://library.ebooks.com/effective-java.pdf", 5.2));
        eBooks.add(new EBook("Python Crash Course", "Eric Matthes", "978-1593279288", 200,
                "https://library.ebooks.com/python-crash.pdf", 8.7));

        allItems.addAll(physicalBooks);
        allItems.addAll(eBooks);
        ...
        System.out.println();
        for (LibraryItem item : allItems) { item.displayDetails(); }
        ...
        eBooks.get(0).checkOut(member1); // Should be denied (limit reached)
